...
def button0_clicked():  # non-filter
    ...
    overlay = cv2.imread('BUTTON/samples/0.png', cv2.IMREAD_UNCHANGED)
    filter_camera()
...
def button1_clicked():
    ...
    overlay = cv2.imread('BUTTON/samples/1.png', cv2.IMREAD_UNCHANGED)
    filter_camera()
...
def button2_clicked():
    ...
    overlay = cv2.imread('BUTTON/samples/2.png', cv2.IMREAD_UNCHANGED)
    filter_camera()
...
def button3_clicked():
    ...
    overlay = cv2.imread('BUTTON/samples/3.png', cv2.IMREAD_UNCHANGED)
    filter_camera()
...
def button4_clicked():
    ...
    overlay = cv2.imread('BUTTON/samples/4.png', cv2.IMREAD_UNCHANGED)
    filter_camera()
...
app.setWindowIcon(QIcon('BUTTON/samples/icon.png'))  # 위젯창 아이콘 설정
...
face_cascade = cv2.CascadeClassifier(
    'BUTTON/samples/haarcascade_frontalface_default.xml')
