...
def get_mask_prob(detections, index, confThres, image, model):
...
def mask_image():
	...
	for i in range(0, detections.shape[2]):
                ...
                (startX, startY, endX, endY, mask, withoutMask) = get_mask_prob(detections, i, args["confidence"], image, model)
